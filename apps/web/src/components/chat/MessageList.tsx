    ...
    if (messages.length === 0) {
        return (
            <div className="flex flex-1 flex-col items-center justify-center p-8 text-center text-gray-500">
                ...
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Ask anything!</h3>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
            ...
            {isLoading && (
                <div className="flex gap-3">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-600">
                        <Bot className="h-5 w-5" />
                    </div>
