        ...
        return (
            <div className="text-center py-12">
                ...
                <p className="text-gray-900 dark:text-white mb-8">
                    You scored <span className="font-bold text-indigo-600 dark:text-indigo-400">{score}</span> out of <span className="font-bold text-gray-900 dark:text-white">{questions.length}</span>
                </p>
                <button
                    onClick={generateQuiz}
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200/30 dark:border-[#383e59]/40 shadow-sm transition-colors duration-300">
            ...
            <div className="p-6">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200/30 dark:border-[#383e59]/40 p-6 shadow-sm mb-6 transition-colors duration-300">
                    <QuestionCard
