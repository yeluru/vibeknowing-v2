...
export function ContentViewer({ url, title }: ContentViewerProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            {embedUrl ? (
                <div className="relative w-full bg-gray-100 dark:bg-slate-700 rounded-lg overflow-hidden border border-slate-200/30 dark:border-slate-800/40">
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-gray-50 dark:bg-slate-700 rounded-lg border border-slate-200/30 dark:border-slate-800/40">
