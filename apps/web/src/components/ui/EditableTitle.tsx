        ...
        return (
            <div className={cn("flex items-center gap-2", className)} onClick={(e) => {
                ...
                <input
                    ...
                    onBlur={handleSave}
                    className={cn(
                        "bg-white dark:bg-slate-800 border-2 border-indigo-500 rounded px-2 py-1 outline-none text-gray-900 dark:text-gray-100 w-full transition-all placeholder:text-gray-400 dark:placeholder:text-slate-500",
