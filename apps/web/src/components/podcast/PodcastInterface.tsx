...
export function PodcastInterface({ sourceId }: { sourceId: string }) {
    ...
    return (
        <div className="flex flex-col gap-6 py-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* ── AUDIO PLAYER CARD ────────────────────────────────────────── */}
            <div className="bg-white/80 dark:bg-[var(--surface-input)]/60 backdrop-blur-xl p-8 rounded-3xl border border-slate-200/70 dark:border-[var(--surface-border)] shadow-sm overflow-hidden relative group">
                {/* Background Decor */}
            ...
            {/* ── TRANSCRIPT ─────────────────────────────────────────────────── */}
            <div className="bg-white/80 dark:bg-[var(--surface-input)]/60 backdrop-blur-xl rounded-3xl border border-slate-200/70 dark:border-[var(--surface-border)] shadow-sm p-8">
